...
type CatalogStatus={available:boolean;total:number;rated:number;syncing:boolean;sources:Array<{source:string;status:string;phase:string;processed:number;startedAt?:string;completedAt?:string;error?:string}>;progress?:{step:number;steps:number;ratio:number};databaseBytes:number;lastSyncAt?:string;nextSyncAt?:string;intervalHours:number;tmdb:{configured:boolean;source:string}};
